...
Playwright coverage now asserts per-binding cards, global counts, and absence of the removed attention testids. #039 verification passed: `PATH=/home/james/.local/bin:$PATH pnpm test:e2e` (37 passed), `pnpm exec tsc --noEmit`, touched-file LSP diagnostics clean, and fresh review `RALPH_REVIEW: PASS`. [source: web/frontend/tests/dashboard.spec.ts] [source: .kanban/progress.md]

## Claims

C-0116 and C-0140 in [CLAIMS.md](../CLAIMS.md).
