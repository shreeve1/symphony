...
| [analyses/symphony-skills-index.md](analyses/symphony-skills-index.md) | Podium-era `symphony-*` skill suite — binding-scaffold, smoke/status Podium API paths, Plane retirement split, catalog maintenance skills, lifecycle map | `.claude/skills/symphony-*`, `skill_migration.py`, `tests/skills/` | 2026-06-12 |
...
| [analyses/podium-031-board-overview-dashboard.md](analyses/podium-031-board-overview-dashboard.md) | #031 Podium board overview dashboard — root `/` cross-binding cards, global state roll-up, attention list, last activity, and `/<binding>?issue=<id>` flyout deep links | `web/frontend/app/page.tsx`, `web/frontend/components/KanbanBoard.tsx`, `web/frontend/tests/dashboard.spec.ts` | 2026-06-12 |
